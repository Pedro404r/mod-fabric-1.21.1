...
public class ItemsRegister {
  ...
  public static final Item MONARCH_SWORD = register("monarch_sword",
      new SwordItem(ToolMaterials.DIAMOND, new Item.Settings().attributeModifiers(
          SwordItem.createAttributeModifiers(ToolMaterials.DIAMOND, 3, -2.4F))));


  public static final Item REGAL_PICKAXE =
      register("regal_pickaxe", new PickaxeItem(ToolMaterials.DIAMOND, new Item.Settings()));

  public static final Item ROYAL_COIN = register("royal_coin", new Item(new Item.Settings()));

  public static final Item ROYAL_COIN_BLOCK =
      register("royal_coin_block", new Item(new Item.Settings()));
